...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__navbar_navbar_component__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__dashboard_chat_list_chat_list_component__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__dashboard_chat_room_chat_room_component__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dashboard_chat_room_chat_bar_chat_bar_component__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__dashboard_dashboard_component__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__dashboard_chat_room_message_message_component__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__home_home_component__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__angular_router__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__login_login_component__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__register_register_component__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__profile_profile_component__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__contacts_contacts_component__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__guards_auth_guard__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__guards_loggedIn_guard__ = __webpack_require__(125);
...
var DashboardComponent = (function () {
    function DashboardComponent(authService, chatService) {
        this.authService = authService;
        this.chatService = chatService;
        this.chatroomData = { chatname: '', messages: [] };
        this.chatlistData = [{ chat: '', badge: 0 }];
    }
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getProfile().subscribe(function (profile) {
            _this.chatlistData = profile.user.contacts.map(function (chatItem) { return { chat: chatItem, badge: 0 }; });
            _this.onChatSelected(_this.chatlistData[0]);
        }, function (err) {
            console.log(err);
            return false;
        });
        this.connection = this.chatService.getMessages().subscribe(function (incomingMessage) {
            ...
            if (chatname == _this.chatroomData.chatname) {
                ...
                _this.chatlistData[index].badge += 1;
            }
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client__ = __webpack_require__(262);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_jwt__ = __webpack_require__(137);
